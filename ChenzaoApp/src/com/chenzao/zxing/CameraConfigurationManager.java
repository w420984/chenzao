...
final class CameraConfigurationManager {
  ...
  void setDisplayOrientation(Camera camera) {
    ...
    if(Build.VERSION.SDK_INT >= 8) {
    	if(mWindManager == null){
    		mWindManager = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
    	}
        int degree = mWindManager.getDefaultDisplay().getRotation();
        switch (degree) {
        ...
        setDisplayOrientation(camera, degree);
    } else {
