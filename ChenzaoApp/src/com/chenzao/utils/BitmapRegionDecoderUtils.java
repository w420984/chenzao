...
public class BitmapRegionDecoderUtils {
    ...
    public static Object newInstance( String pathName, boolean isShareable ) {
        ...
        return mReflection.invokeStaticMethod( CLASS_NAME, METHOD_NAME, 
                new Class<?>[] { String.class, boolean.class }, 
                new Object[] { pathName, isShareable } );
    }
    ...
    public static Object newInstance(FileDescriptor fd, boolean isShareable) {
        final String METHOD_NAME = "newInstance";
        return mReflection.invokeStaticMethod( CLASS_NAME, METHOD_NAME, 
                new Class<?>[] { FileDescriptor.class, boolean.class }, 
                new Object[] { fd, isShareable } );
    }
    ...
    public static Object newInstance( byte[] data, int offset, int length, boolean isShareable ) {
        ...
        return mReflection.invokeStaticMethod( CLASS_NAME, METHOD_NAME,
                ...
                new Object[] { data, offset, length, isShareable } );
    }
     ...
     * @return
     */
    public static Bitmap decodeRegion( Object bitmapRegionDecoder, Rect rect,
            BitmapFactory.Options options ) {
        return (Bitmap) mReflection.invokeMethod( bitmapRegionDecoder, "decodeRegion",
                new Class<?>[] { Rect.class, BitmapFactory.Options.class }, 
                new Object[] { rect, options } );
    }
