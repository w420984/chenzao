...
import com.chenzao.net.NetworkConnectivityListener;
...
public class NetUtils {
    ...
    public static String openUrl(String url, String method, Bundle params, Context context,
            boolean checkResult, IDownloadState callback) throws ChenzaoIOException, ChenzaoParseException, ChenzaoApiException {
...
//                }
        		...
        		try {
					...
					e.printStackTrace();
					throw new ChenzaoApiException("Encoding error");
				} catch (ClientProtocolException e) {
					e.printStackTrace();
					throw new ChenzaoApiException("Api error");
				}catch (IOException e) {
					e.printStackTrace();
					throw new ChenzaoParseException("IO error");
				}catch (Exception e){
					e.printStackTrace();
					throw new ChenzaoApiException("Api error");
				}
                ...
                if (err == null || err.errorcode == null || "".equals(err.errorcode) || "1".equals(err.errorcode)) {
                    ...
                    throw new ChenzaoApiException(err);
                }
            } else {
                throw new ChenzaoIOException(ChenzaoIOException.REASON_HTTP_METHOD);
            }
        }finally{
    ...
    private static String execute(HttpClient client, HttpUriRequest request, Context context) throws ChenzaoIOException, ChenzaoParseException, ChenzaoApiException{
        /**
        ...
        try {
        	...
        	e.printStackTrace();
        	throw new ChenzaoIOException(e);
        }
    ...
    private static String executeWithoutParse(HttpClient client, HttpUriRequest request,
            Context context) throws ChenzaoIOException {
        /**
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    throw new ChenzaoIOException(e1);
                } finally {
            ...
            if (statusCode != Constants.HTTP_STATUS_OK) {
            	...
            	ChenzaoIOException ex = new ChenzaoIOException(String.format(
    ...
    public static HttpClient getHttpsClientForWifi(Context context, String url) throws ChenzaoIOException{
        HttpClient client = null;
    ...
    public static HttpClient getHttpClient(Context context) throws ChenzaoIOException {
        NetUtils.NetworkState state = NetUtils.getNetworkState(context);
        HttpClient client = new DefaultHttpClient();
        if (state == NetUtils.NetworkState.NOTHING) {
            throw new ChenzaoIOException("NoSignalException");
