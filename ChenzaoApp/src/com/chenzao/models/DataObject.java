...
public abstract class DataObject{
    ...
    public DataObject(String xmlStr) throws ChenzaoParseException{
    ...
    public DataObject(XmlPullParser _parser) throws ChenzaoParseException{
        initFromParser(_parser);
    }
    
	public abstract DataObject initFromString(String xmlStr) throws ChenzaoParseException;
	
	public abstract DataObject initFromParser(XmlPullParser _parser) throws ChenzaoParseException;
	
	protected abstract DataObject parse() throws ChenzaoParseException;
	
	protected String parseText(XmlPullParser parser) throws ChenzaoParseException {
        try {
	 ...
	 */
    protected String parseMultiLineText(XmlPullParser parser, String tag) throws ChenzaoParseException {
